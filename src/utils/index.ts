...
export const MOCK_MENTORS = [
  {
    ...
    categories: ['senior-advisory-group'],
    sessionPrice: 299,
    rating: 4.9,
    reviewCount: 127,
    totalSessions: 420,
  ...
  {
    uid: 'guide-devesh-kumar',
    displayName: 'Devesh Kumar',
    email: 'deveshkumar8423gola@gmail.com',
    photoURL: '',
    bio: 'Guide with a B.Tech background and psychology exposure. Designs user reflection journeys and practical frameworks for self-understanding.',
    domains: ['clarity', 'values', 'growth', 'emotional'] as DomainId[],
    expertise: ['Reflection Journeys', 'Self-Awareness Frameworks', 'Life Clarity'],
    categories: ['peer-buddy', 'young-mentor'],
    sessionPrice: 129,
    rating: 5,
    reviewCount: 0,
    totalSessions: 0,
    availability: {},
    yearsOfExperience: 1,
    education: 'B.Tech + Background in Psychology',
    languages: ['Hindi', 'English'],
    isVerified: true,
  },
  {
    uid: 'guide-parmita',
    displayName: 'Parmita',
    email: 'Adibee809@gmail.com',
    photoURL: '',
    bio: 'Psychology guide with a B.Sc Psychology background, focused on listening, reflection, and supportive life guidance.',
    domains: ['emotional', 'stress', 'relationships', 'confidence'] as DomainId[],
    expertise: ['Psychology-Based Support', 'Emotional Reflection', 'Confidence Guidance'],
    ...
    languages: ['Hindi', 'English'],
    isVerified: true,
    instagram: 'parmit_194',
  },
  {
    uid: 'guide-nakul-fitness',
    displayName: 'Nakul',
    email: 'nakul827976@gmail.com',
    photoURL: '',
    bio: 'Fitness guide helping beginners with strength training, weight loss guidance, muscle building basics, and workout planning.',
    domains: ['lifestyle', 'productivity', 'confidence'] as DomainId[],
    expertise: ['Strength Training', 'Weight Loss Guidance', 'Muscle Building Basics', 'Workout Planning'],
    categories: ['young-mentor'],
    sessionPrice: 199,
    rating: 5,
    reviewCount: 0,
    totalSessions: 0,
    availability: {},
    yearsOfExperience: 3,
    education: 'B.Tech CSE Student, 2nd Year',
    languages: ['Hindi', 'English'],
    isVerified: true,
  },
]
