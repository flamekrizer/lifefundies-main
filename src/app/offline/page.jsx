      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
          >
            Go Back
          </button>
        </div>
        ...
        <div className="mt-12 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-semibold">Pro Tip:</span> Previously visited pages may still work offline!
          </p>
        </div>
      </div>
    </div>
